...
if [ $# -gt 0 ]; then
  ...
  run test_rules; run test_roll; run test_morale; run test_overwatch; run test_undo; run test_aiplan; run test_projection; run test_pressure
  run test_menu; run test_save_load; run test_progression; run test_hero_gameover
  run test_returners; run test_bounty; run test_occlusion
